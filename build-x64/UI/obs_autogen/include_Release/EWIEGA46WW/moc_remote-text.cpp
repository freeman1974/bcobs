...
struct qt_meta_stringdata_RemoteTextThread_t {
    QByteArrayData data[5];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RemoteTextThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RemoteTextThread_t qt_meta_stringdata_RemoteTextThread = {
    {
QT_MOC_LITERAL(0, 0, 16), // "RemoteTextThread"
...
QT_MOC_LITERAL(4, 30, 5) // "error"
    ...
    "RemoteTextThread\0Result\0\0text\0error"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_RemoteTextThread[] = {
...
void RemoteTextThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RemoteTextThread::Result)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RemoteTextThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_RemoteTextThread.data,
    qt_meta_data_RemoteTextThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RemoteTextThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RemoteTextThread.stringdata0))
