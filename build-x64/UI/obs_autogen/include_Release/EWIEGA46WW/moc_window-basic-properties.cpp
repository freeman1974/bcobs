...
QT_MOC_LITERAL(5, 65, 16) // "AddPreviewButton"

    },
    "OBSBasicProperties\0on_buttonBox_clicked\0"
    "\0QAbstractButton*\0button\0AddPreviewButton"
};
...
void OBSBasicProperties::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OBSBasicProperties *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_buttonBox_clicked((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        case 1: _t->AddPreviewButton(); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject OBSBasicProperties::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_OBSBasicProperties.data,
    qt_meta_data_OBSBasicProperties,
    qt_static_metacall,
    nullptr,
    nullptr
} };
