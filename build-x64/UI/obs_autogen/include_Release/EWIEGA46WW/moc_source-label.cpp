...
void OBSSourceLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OBSSourceLabel::Renamed)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OBSSourceLabel::Removed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (OBSSourceLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OBSSourceLabel::Destroyed)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OBSSourceLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_OBSSourceLabel.data,
    qt_meta_data_OBSSourceLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
