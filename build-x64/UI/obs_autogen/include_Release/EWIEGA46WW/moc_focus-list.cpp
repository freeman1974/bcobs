...
void FocusList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FocusList *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (FocusList::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FocusList::GotFocus)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FocusList::staticMetaObject = { {
    QMetaObject::SuperData::link<QListWidget::staticMetaObject>(),
    qt_meta_stringdata_FocusList.data,
    qt_meta_data_FocusList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
