...
class gs_monitor_info(_object):
    ...
    __swig_setmethods__["monitor_name"] = _obspython.gs_monitor_info_monitor_name_set
    __swig_getmethods__["monitor_name"] = _obspython.gs_monitor_info_monitor_name_get
    if _newclass:
        monitor_name = _swig_property(_obspython.gs_monitor_info_monitor_name_get, _obspython.gs_monitor_info_monitor_name_set)
    __swig_setmethods__["flags"] = _obspython.gs_monitor_info_flags_set
    __swig_getmethods__["flags"] = _obspython.gs_monitor_info_flags_get
    if _newclass:
        flags = _swig_property(_obspython.gs_monitor_info_flags_get, _obspython.gs_monitor_info_flags_set)
